/**
 * GitHub MCP Integration - DEPRECATED
 * Provides utilities for working with the GitHub API through MCP
 *
 * @deprecated Use the GitHubMCPServerAdapter from the adapters module instead
 */
...
export class GitHubMCPClient {
  ...
  constructor(private readonly _serverName: string = 'github') {
    this._loadToken();
    logger.warn('GitHubMCPClient is deprecated. Use GitHubMCPServerAdapter instead.');
  }
 ...
 *
 * @deprecated Use createServerAdapter('github', ...) and MCPServerRegistry instead
 */
export function getGitHubMCPClient(serverName: string = 'github'): GitHubMCPClient {
  logger.warn('getGitHubMCPClient is deprecated. Use the new modular architecture instead.');
