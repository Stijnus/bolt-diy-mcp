...
import MCPServersTab from '~/components/@settings/tabs/mcp-servers/MCPServersTab';
...
const TAB_DESCRIPTIONS: Record<TabType, string> = {
  ...
  'mcp-servers': 'Configure Model Context Protocol (MCP) servers',
};

// Beta status for experimental features
const BETA_TABS = new Set<TabType>(['task-manager', 'service-status', 'update', 'local-providers', 'mcp-servers']);
